...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        #     "Compare the difference between object(s) and find the most closely matched object(s)." \
        #     "Output the thinking process inside <think>...</think>." \
        #     "Inside this reasoning, you must include one or more <wait>...</wait> blocks, enclosing the parts of the reasoning where you pay special attention to certain visual information." \
        #     " Then, output the final answer inside <answer>...</answer>." \
        #     " Output the bbox(es) and point(s) inside the interested object(s) in JSON format." \
        #     " i.e., <think> [your reasoning text] <wait> [your visual focus] </wait> [more reasoning text] </think>" \
        #     "<answer>{Answer}</answer>"    
